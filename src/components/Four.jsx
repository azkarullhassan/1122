...
const Four = () => {
  return (
    <section className='w-full'>
       <main className=' flex md:flex-row flex-col justify-center gap-6 md:p-0 p-10'>
       <div >
        <img className='' src="/src/assets/1st 1.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#AF7200] rounded-[8px] text-[16px] text-white font-bold'>
        Entrepreneurship
          </button>
          <h1 className='font-bold text-[20px] pt-4'>The most innovative businesses of 2022
           </h1>
        ...
        <div>
        <img className='' src="/src/assets/1st 2.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#3F51B5] rounded-[8px] text-[16px] text-white font-bold'>
        Startups
          </button>
          <h1 className='font-bold text-[20px] pt-4'>Businesses with a social conscience</h1>
        ...
        <div>
        <img  src="/src/assets/1st 3.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#370085] rounded-[8px] text-[16px] text-white font-bold'>
       News
          </button>
          <h1 className='font-bold text-[20px] pt-4 '>Young entrepreneurs making their mark</h1>
...
{/* second */}
       ...
       <main className=' flex md:flex-row flex-col justify-center gap-6 pt-24 md:p-0 p-10'>
       <div >
        <img className='' src="/src/assets/2nd 1.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#3F51B5] rounded-[8px] text-[16px] text-white font-bold'>
        Startups
          </button>
        ...
        <div>
        <img className='' src="/src/assets/2nd 2.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#AF7200] rounded-[8px] text-[16px] text-white font-bold'>
        Entrepreneurship
          </button>
        ...
        <div>
        <img  src="/src/assets/2nd 3.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#008F62] rounded-[8px] text-[16px] text-white font-bold'>
        Stock Market
          </button>
          <h1 className='font-bold text-[20px] pt-4 '>SCase studies of businesses that have
            succ <br />eeded against the odds</h1>
       ...
       {/* third */}
       <main className=' flex md:flex-row flex-col md:p-0 p-10 justify-center gap-6 pt-24'>
       <div >
        <img className='' src="/src/assets/3rd 1.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#0067B9] rounded-[8px] text-[16px] text-white font-bold'>
        Investments
          </button>
          <h1 className='font-bold text-[20px] pt-4'>
          Business news for students for us</h1>
            <p className='pt-2'>Provident quaerat at nisi dolorem vel fac</p>
            <div className="  pt-16 flex gap-2 "> 
            <h2 className='font-bold text-[20px]'>Read more</h2>
          <FaAngleRight className="mt-2.5" />
        ...
        <div>
        <img className='' src="/src/assets/3rd 2.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#AF7200] rounded-[8px] text-[16px] text-white font-bold'>
        Entrepreneurship
          </button>
          <h1 className='font-bold text-[20px] pt-4'>How to get ahead in business</h1>
          <p className='pt-2'>Ad cupiditate excepturi dolores quam et <br /> et sed
               um minima. Et vitae voluptates
                </p>
          <div className="  pt-6 flex gap-2 "> 
            <h2 className='font-bold text-[20px]'>Read more</h2>
          <FaAngleRight className="mt-2.5" />
        ...
        <div>
        <img  src="/src/assets/3rd 3.png" alt="arrow" />
        <button className='border-[1px] mt-4 md:px-8 px-2 py-1 bg-[#AF7200] rounded-[8px] text-[16px] text-white font-bold'>
        Entrepreneurship
          </button>
